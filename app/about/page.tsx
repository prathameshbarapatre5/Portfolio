                ...
                <div className='grid w-full grid-cols-8 gap-16 sm:gap-8'>
                    <div className='col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8'>
                        ...
                        <p className='font-medium'>
                            Hi, I am Prathmesh Barapatre, a Robotics Engineer and Space Enthusiast with a passion for creating functional, futuristic, and innovative technological solutions. With years of experience in mechatronics and leadership roles at the National Space Society.
                        </p>
