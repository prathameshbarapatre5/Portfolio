...
const BackgroundEffects = () => {
    return (
        <>
            ...
            <div className="fixed top-1/2 left-1/2 w-[400px] h-[400px] bg-primary/10 rounded-full blur-[100px] animate-float pointer-events-none -translate-x-1/2 -translate-y-1/2 z-0" />
        </>
    )
}
