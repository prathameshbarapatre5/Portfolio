    ...
    return (
        <>
            ...
            <div className='w-full h-screen relative flex items-center justify-center rounded-full bg-circularLight dark:bg-circularDark lg:h-[80vh] sm:h-[60vh] xs:h-[50vh]'>
                ...
                <Skill name="Mechatronics" x="-20vw" y="2vw" />
                <Skill name="Space Tech" x="-5vw" y="-10vw" />
                <Skill name="Python" x="20vw" y="6vw" />
                <Skill name="ROS" x="0vw" y="12vw" />
                <Skill name="C++" x="-20vw" y="-15vw" />
                <Skill name="MATLAB" x="15vw" y="-12vw" />
                <Skill name="Research" x="32vw" y="-5vw" />
                <Skill name="Teaching" x="0vw" y="-20vw" />
                <Skill name="SolidWorks" x="-25vw" y="18vw" />
                <Skill name="Control Systems" x="18vw" y="18vw" />
            </div>
        </>
    )
}
